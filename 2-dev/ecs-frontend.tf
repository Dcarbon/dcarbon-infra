...
#   IMAGE_FILE_PATH       = "${path.cwd}/../../${var.PROJECT_NAME_REPOSITORY}-${var.PROJECT_SERVICES.FRONTEND}"
#   BUILD_ARG             = "NEXT_PUBLIC_API_ENDPOINT=https://${local.backend-domain}"
...
#   CONTAINER_ENVIRONMENT     = var.FRONTEND_ENV
#   TAGS = merge(local.common-tags, { Service : var.PROJECT_SERVICES.FRONTEND })
# }
#
